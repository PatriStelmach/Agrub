...
import NavDocuments from '@/pages/navbar/NavDocuments.vue'
import NavMain from '@/pages/navbar/NavMain.vue'
...
<template>
  <Sidebar class="bg-card z-100">
    <SidebarHeader class="bg-card h-[5vh]">
      <SidebarMenu>
        <SidebarMenuItem>
          <SidebarMenuButton
            as-child
          ...
          >
            <router-link class="items-start" to="/">
              <Siren class="size-5!" />
