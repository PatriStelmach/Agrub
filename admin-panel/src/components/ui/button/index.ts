  ...
  "inline-flex  cursor-pointer items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-150! disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-red-badge/20 aria-invalid:ring-red-badge/40 aria-invalid:border-red-badge",
  {
    variants: {
      variant: {
        ...
        outline:
          " bg-background border-2  shadow-xs hover:bg-accent hover:text-accent-foreground bg-input/30 border-input hover:bg-input",
        secondary:
        ...
        green_outline:
        "bg-background border-2  font-bold border-input  hover:bg-green-badge/60 bg-input/30 text-green-badge/90 light:hover:bg-green-badge/70 hover:border-green-badge hover:text-primary",
        yellow_outline:
          "bg-background border-2  font-bold border-input  bg-input/30 text-yellow-badge/90 light:hover:bg-yellow-badge/70 hover:bg-yellow-badge/80 hover:border-yellow-badge hover:text-primary",
        red_outline:
