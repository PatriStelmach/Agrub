...
export const tableHeaders = "hover:bg-background bg-background border-b-2! gap-0 space-0 "
export const tableDiv = " mt-[2vh] mx-[1%] w-98/100 relative overflow-auto max-md:max-h-[80vh]  max-h-[85vh]   "
...
export const gridSkeletons = " px-6 py-2 pr-3 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 max-h-[85vh] overflow-y-auto"
export const gridCard = "shadow-[5px_5px_10px_1px] shadow-secondary border-2 my-2  min-h-44 flex  hover:border-blue-badge/50 hover:shadow-blue-badge/50 transition-all duration-100"
export const gridSystemCardUnwrapped =
  "shadow-[5px_5px_10px_1px]  border-2 my-2 flex transition-all duration-100 cursor-auto relative h-90 lg:h-100 xl:h-120 border-blue-badge/50 shadow-blue-badge/50"
export const gridSystemCard =
  "shadow-[5px_5px_10px_1px] shadow-secondary border-2 my-2 cursor-auto relative h-90 lg:h-100 xl:h-120 flex  hover:border-blue-badge/50 hover:shadow-blue-badge/50 transition-all duration-100"

export const hoverListRow = (extra = '') => `odd:bg-accent/30 hover:bg-blue-badge/10 ${extra}`.trim()
