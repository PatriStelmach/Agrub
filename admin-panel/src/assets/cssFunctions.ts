...
export const gridCard = "shadow-[5px_5px_10px_1px] shadow-secondary border-2 my-2 user-box min-h-44 flex  hover:border-blue-badge/50 hover:shadow-blue-badge/50 transition-all duration-100"
