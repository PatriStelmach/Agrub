...
export const bigNameLabel = 'font-bold text-label text-md xl:text-xl 2xl:text-2xl'
...
export const gridSystemCardUnwrapped =
  "shadow-[5px_5px_10px_1px]  border-2 my-2 flex transition-all  cursor-auto relative h-90 lg:h-100 xl:h-120 border-blue-badge/50 shadow-blue-badge/50"
export const gridSystemCard =
  "shadow-[5px_5px_10px_1px] shadow-secondary border-2 my-2 cursor-auto relative h-90 lg:h-100 xl:h-120 flex  hover:border-blue-badge/50 hover:shadow-blue-badge/50 transition-all "
