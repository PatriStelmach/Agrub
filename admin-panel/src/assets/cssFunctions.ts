...
export const gridSkeletons = " px-6 py-2 pr-3 grid sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6 max-h-[85vh] overflow-y-auto"
export const gridCard = "shadow-[5px_5px_10px_1px] shadow-secondary border-2 my-2 user-box h-44 flex hover:shadow-md hover:border-blue-badge/50 hover:shadow-blue-badge/50 transition-all duration-200 hover:translate-y-2"
